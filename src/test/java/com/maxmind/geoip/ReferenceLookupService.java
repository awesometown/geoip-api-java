...
/**
 * Unmodified version of Maxmind's LookupService class; used to test modified LookupService for consistent results.
 *
...
public class ReferenceLookupService {
	...
	private static final String[] countryName = {
			...
			"Falkland Islands (Malvinas)", "Micronesia, Federated States of", "Faroe Islands", "France", "Sint Maarten (Dutch part)", "Gabon",
			...
			"Japan", "Kenya", "Kyrgyzstan", "Cambodia", "Kiribati", "Comoros", "Saint Kitts and Nevis", "Korea, Democratic People's Republic of",
			...
			"Papua New Guinea", "Philippines", "Pakistan", "Poland", "Saint Pierre and Miquelon", "Pitcairn Islands", "Puerto Rico", "Palestinian Territory",
			"Portugal", "Palau",
			...
			"Virgin Islands, British", "Virgin Islands, U.S.", "Vietnam", "Vanuatu", "Wallis and Futuna", "Samoa", "Yemen", "Mayotte", "Serbia",
			"South Africa",
	 ...
	 */
	public ReferenceLookupService(String databaseFile, String licenseKey) throws IOException {
	 ...
	 *            license key provided by Maxmind to access distributed service
	 */
	public ReferenceLookupService(File databaseFile, String licenseKey) throws IOException {
		this(databaseFile);
		this.licenseKey = licenseKey;
		dnsService = 1;
	}
	 ...
	 *            license key provided by Maxmind to access distributed service
	 */
	public ReferenceLookupService(int options, String licenseKey) throws IOException {
		this.licenseKey = licenseKey;
		dnsService = 1;
		init();
	}
	 ...
	 */
	public ReferenceLookupService(String databaseFile) throws IOException {
		this(new File(databaseFile));
	}
	 ...
	 *             if an error occured creating the lookup service from the database file.
	 */
	public ReferenceLookupService(File databaseFile) throws IOException {
	 ...
	 *            String representation of the database file.
	 * @param options
	 *            database flags to use when opening the database GEOIP_STANDARD read database from disk GEOIP_MEMORY_CACHE cache the database in RAM and read
	 *            it from RAM
	 * @throws java.io.IOException
	 *             if an error occured creating the lookup service from the database file.
	 */
	public ReferenceLookupService(String databaseFile, int options) throws IOException {
	 ...
	 *             if an error occured creating the lookup service from the database file.
	 */
	public ReferenceLookupService(File databaseFile, int options) throws IOException {
		this.databaseFile = databaseFile;
		this.file = new RandomAccessFile(databaseFile, "r");
		dboptions = options;
		init();
